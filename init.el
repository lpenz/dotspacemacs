...
values."
  ...
  (setq-default
   ...
   dotspacemacs-default-font '(
                               "DejaVuSansMonoForPowerline Nerd Font:size=15:antialias=true:autohint=true"
                               ; "DejaVuSansMono:size=15:antialias=true:autohint=true"
                               ; "SourceCodePro:size=13:weight=normal:width=normal"
                               :powerline-scale 1.1
                               )
   ;; The leader key
